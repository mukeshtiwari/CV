...
\cvitem{Description}{Our goal was to develop an unhackable electronic vote-counting software;
therefore, we focussed on three main challenges posed by electronic voting: 
