...
\recipient{To}{The Hiring Committee \\ University name, Place, Country}
\date{}
\opening{\textbf{Application for the post of Name}}
...
and social choice theory. I am writing to apply for the job 
\textbf{Position} at the \textbf{Name of the University}. 
...
session types. Our goal is to automatically generate correct APIs in a distributed 
setting for protocols used in \textbf{Signal} and other chat messengers. 
...
research is the key to solve challenging problem pertaining to society. Therefore, I like to chat and work with 
diverse set of researchers, which is evident from my projects involving 
