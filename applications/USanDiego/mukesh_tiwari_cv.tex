...
\section{Skills}
\cvitem{Coding}{Coq, Lean, Haskell, OCaml, Python, C, C++, Java, Racket}
...
\cvitem{[1]}{{Thomas Haines, Rajeev Gor{\'e}, and Mukesh Tiwari.
    ...
    (co-developer with Thomas Haines. I proved facts related to Vandermonde matrix in the Coq theorem prover)}


\cvitem{[2]}{{Nadim Kobeissi, Georgio Nicolas, and Mukesh Tiwari. 
...
\cvitem{[3]}{{Thomas Haines, Rajeev Gor{\'e}, and Mukesh Tiwari. 
...
\cvitem{[4]}{{Thomas Haines, Dirk Pattinson, and Mukesh Tiwari.} 
...
\cvitem{[5]}{{Milad K. Ghale, Rajeev Gor{\'e}, Dirk Pattinson, and Mukesh Tiwari.
...
\cvitem{[6]}{{Lyria Bennett Moses, Rajeev Gor{\'e}, Ron Levy, Dirk Pattinson, and Mukesh Tiwari.}
...
\cvitem{[7]}{{Dirk Pattinson and Mukesh Tiwari.} {Schulze Voting as Evidence Carrying Computation}. 
...
\cvitem{[8]}{{Mukesh Tiwari, Karm V. Arya, Rahul Choudhari, and Kumar S. Choudhary. 
...
\cvitem{[9]}{{Rahul Choudhari, Karm V. Arya, Mukesh Tiwari, and Kumar S. Choudhary. 
...
\cvitem{[5]}{Towards Leakage-Resistant Machine Learning in Trusted Execution Environments. 
...
\cvitem{[6]}{{Machine Checked Properties of the Schulze Method. In this work, 
