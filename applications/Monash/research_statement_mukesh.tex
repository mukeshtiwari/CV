...
that I would like to focus at King's College London, if given the position.
...
and use MetaCoq to get a verified machine code from my formalisation. 
...
collaborate on the ideas that matters to democracies and societies. At King's College, 
I can collaborate with Prof. Martin Albrecht on formal verification of 
post-quantum cryptography 
where I can combine my formal verification expertise with his post-quantum 
expertise; I can collaborate with  Dr Ruba Abu-Salma
on human-centred 
security for the computer programs used in democratic elections. 
