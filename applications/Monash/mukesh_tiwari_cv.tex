...
\cvitem{[1]}{Verified Secure Declassification for Concurrent Applications. In this work, 
    ...
    server, aution-server, and email-server in SecureC). (submitted to ACM CCS).}
\cvitem{[2]}{Formally Verified Verifiable Group Generators. In this work, we develop a formally 
    verified algorithm that can be used to bootstrap a democratic election (sole author). 
    (submitted to E-Vote).
...
\cvitem{[3]}{Modelling Networking Protocols Mathematically. In this work, we develop 
    ...
    the Coq theorem prover). (submitted to ICNP).
    \url{https://github.com/mukeshtiwari/Semiring_graph_algorithm}}   
       
\cvitem{[4]}{An Algebraic Framework for Multi-Objective Optimisation. In this work, we develop 
...
\cvitem{[1]}{Reviewer for ACM Transactions on Privacy and Security}
\cvitem{[2]}{Reviewer for Sadhana - Academy Proceedings in Engineering Sciences}
