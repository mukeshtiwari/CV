...
\cventry{2021-}{Senior Research Fellow}{University of Cambridge}{Cambridge}{United Kingdom}
  {I am working on formalising network protocols framework in the Coq theorem prover. The goal is to develop a mathematical 
...
the courses I taught were \textit{C programming, Java Programming, Compiler Design} and \textit{Cryptography}.  
In addition,  every year I supervised two
...
\cvitem{[3]}{Modelling Networking Protocols Mathematically. In this work, we develop 
    ...
    the Coq theorem prover). (ongoing work).
...
\cvitem{[4]}{Machine Checking the Bayer-Groth Proof of Shuffle. In this work, 
    ...
    I proved facts related to Vandermonde matrix in the Coq theorem prover). (major revision USENIX 2023).}
\cvitem{[5]}{Theorem Provers to Protect Democracies. In this work, we are formalising 
    ...
    prover. Our goal is to replace the SwissPost Java implementations ({\url{https://bit.ly/3EODmnF}})
	with mathematically proven correct Coq implementations
    write an independent verifier for the scrutine sheet of elections conducted by 
...
\begin{cvcolumns}
  \cvcolumn{}{\begin{itemize}\item  V{\'e}ronique Cortier, Research Director, CNRS, LORIA, Nancy, France, veronique.cortier@loria.fr (I have not worked with her but she understands 
    my work very closely. She has kindly agreed to write me a reference letter based on my election security work)
   \end{itemize}}
\end{cvcolumns}
