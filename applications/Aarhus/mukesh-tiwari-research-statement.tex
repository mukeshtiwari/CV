...
\section{Future Work}
\begin{itemize}
    \item I would like to focus, with Bas Spitters and Diego Aranha,  
...
I would like, with Lars Birkedal, to add reasoning support for the Java language in Coq-Iris so that I can 
...
I would like to work on adding information flow support in Coq-Iris --a Coq library-- 
with my co-author Toby Murray and Lars Birkedal.
