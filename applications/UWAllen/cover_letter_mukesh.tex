...
\date{}
\opening{\textbf{Application for the Assistant Professor job}}
...
At Indiana University, as an assistant professor, 
...
International Conference on Cryptology in India (IndoCrypt), USENIX Security,
and some (finished) works have been submitted to SIGCOMM and CCS. 
