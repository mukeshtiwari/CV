...
\cventry{2021-}{Senior Research Fellow}{University of Cambridge}{Cambridge}{United Kingdom}
  {I am working on formalising a network-protocol framework in Coq theorem 
  prover. The goal is to develop a mathematical 
...
\end{cvcolumns}
\begin{cvcolumns}
  \cvcolumn{}{\begin{itemize}\item  V{\'e}ronique Cortier, Research Director, CNRS, LORIA, Nancy, France, veronique.cortier@loria.fr (I 
        have not worked with her but she has agreed to write me a reference letter just based on election security work.)
   \end{itemize}}
\end{cvcolumns}
