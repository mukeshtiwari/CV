...
\recipient{To}{The Hiring Committee, \\
    EPFL, Lausanne}
\date{}
\opening{\textbf{Application for the Faculty Positions in Computer and Communication Sciences}}
...
for the \textbf{Assistant Professor} job in Computer and Communication Sciences. 
I have extensive research experience in
(election) software security, theorem proving (Coq theorem prover), cryptography,  
and social choice theory. My research is highly relevant to the Swiss democracy. 
In many of my projects, I have addressed the problems of SwissPost source code, 
pointed by researchers. For example, I have developed a formally verified independently 
verifiable group generator to bootstrap elections, a formally verified 
scrutiny sheet checker for Swiss elections, and replacing the SwissPost Java 
cryptographic implementation by a Coq implementation and proofs. 
...
At EPFL, as an Assistant Professor, 
