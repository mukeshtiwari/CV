...
\cvitem{[4]}{{Milad K. Ghale, Rajeev Gor{\'e}, Dirk Pattinson, and Mukesh Tiwari.
    Modular Formalisation and Verification of STV Algorithms. In Robert Krimmer, Melanie Volkamer, V{\'e}ronique Cortier, 
    ...
    (co-developer with Milad K. Ghale. I proved some of the cricital theorems, required for code extraction)}
...
\cvitem{[1]}{Verified Secure Declassification for Concurrent Applications. In this work, 
    ...
    In this work, I formally verified ) (submitted).}
...
\cvitem{[3]}{Modelling Networking Protocols Mathematically. In this work, we develop 
    ...
    the security properties of their protocol (joint work Timothy Griffin. I this work, 
    I formally verified ) (submitted)}      
\cvitem{[4]}{Machine Checking the Bayer-Groth Proof of Shuffle. In this work, 
    ...
    I formally verified ) (major revision USENIX 2023)}
