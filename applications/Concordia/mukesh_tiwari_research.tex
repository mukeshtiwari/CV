...
In my current project \emph{Combinators for Algebraic Structures (CAS)} framework,
I am, with Timothy Griffin as lead PI, formalising various graph algorithms on \emph{semiring} algebraic 
structure. In our framework, depending on concrete instantiation 
...
In fact, the Schulze method is one instance of our framework. 
