...
\cvitem{[4]}{Machine Checking the Bayer-Groth Proof of Shuffle. In this work, 
    ...
    including Switzerland to shuffle the ballot (joint work with Thomas Haines, and Rajeev Gore. In this work, 
...
\cvitem{[5]}{Theorem Provers to Protect Democracies. In this work, we are formalising 
    all the cryptographic components written in Java of SwissPost in Coq theorem
