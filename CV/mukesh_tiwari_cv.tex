...
\cvitem{1}{Verified Secure Declassification for Concurrent Applications. In this work, 
    we develop a formal model of leaking sensitive data.}
\cvitem{2}{Formally Verified Verifiable Group Generators. In this work, we develop a formally 
    verified algorithm that can be used to bootstrap a democratic election.}
\cvitem{3}{Modelling Networking Protocols Mathematically. In this work, we develop 
    ...
    the security properties of their protocol}      
...
\cvitem{5}{Theorem Provers to Protect Democracies. In this work, we are formalising 
    ...
    prover. Our goal is to write an independent verifier for scrutine sheet of  elections conducted by 
    Swiss Post software programs.}
...
\end{cvcolumns}
\begin{cvcolumns}
  \cvcolumn{}{\begin{itemize}\item  V{\'e}ronique Cortier, Research Director, CNRS, LORIA, Nancy, France, veronique.cortier@loria.fr
   \end{itemize}}
\end{cvcolumns}
