...
\cvitem{2}{Theorem Provers to Protect Democracies. In this work, we develop a formally 
...
\cvitem{5}{Towards Leakage-Resistant Machine Learning in Trusted Execution Environments. In this
    work, we develop a machine learning algorithm that is proven constant time. It is applicable 
    in a scenario when the training data is sensitive and model is trained in a cloud}.    
