...
a theorem prover to implement the vote counting algorithm (including various 
machine checked proof of correctness), 
privacy concern by using homomorphic encryption  (computed the final tally homomorphically 
